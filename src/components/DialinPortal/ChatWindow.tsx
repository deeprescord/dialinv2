        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-20 left-1/2 transform -translate-x-1/2 w-[90vw] max-w-4xl h-[36rem] glass-card border border-white/10 rounded-lg overflow-hidden z-50 flex flex-col"
            >
            {selectedThread ? (
