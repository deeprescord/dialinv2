...
const PublicSpacePage = () => {
  ...
  // Auto-select the first playable item when entering a public space
  useEffect(() => {
    const autoload = async () => {
      ...
      try {
        ...
        console.log('🚀 PublicSpacePage - Auto-loaded first item:', transformed);
        setSelectedItemData(transformed);
      } catch (e) {
        console.error('❌ PublicSpacePage - Auto-load error:', e);
      }
    };
    autoload();
